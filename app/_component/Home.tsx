      ...
      <div className="relative z-10 w-full max-w-2xl flex flex-col justify-center items-center lg:items-start text-center lg:text-left px-4">
        <div className="space-y-6">
          ...
          <div className="inline-block">
            <span className="px-4 py-2 bg-[#00e786]/10 border border-[#00e786]/30 rounded-full text-[#00e786] text-sm font-medium backdrop-blur-sm">
              Welcome
            </span>
          </div>
          ...
          {/* Description */}
          <p className="text-lg font-bold sm:text-xl lg:text-2xl text-[#00e786] leading-relaxed max-w-xl">
